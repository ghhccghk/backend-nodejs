...
make -j30 LDFLAGS_target="-Wl,-z,max-page-size=16384 -L/home/runner/android-ndk-r27c/obj/local/$OUTPUT -lcpufeatures -Wl,--gc-sections" CFLAGS_target="-Os -fdata-sections -ffunction-sections"
