...
make -j30 LDFLAGS="-Wl,-z,max-page-size=16384 -L/home/runner/android-ndk-r27c/obj/local/$OUTPUT -lcpufeatures -Wl,--gc-sections" CFLAGS="-Os -fdata-sections -ffunction-sections"
